        ...
        <div className='container w-50 mx-auto mt-5 shadow-lg p-5 rounded-3 border'>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control className='' ref={passwordRef} type="password" placeholder="Password" required/>
                </Form.Group>
            ...
            <p className='alter-options'><small>Forget Password?</small><span className='text-primary px-1' role='button' onClick={resetPassword}>Reset password.</span></p>
